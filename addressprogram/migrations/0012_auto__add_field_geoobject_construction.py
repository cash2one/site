...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'GeoObject.construction'
        db.add_column(u'addressprogram_geoobject', 'construction',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'GeoObject.construction'
        db.delete_column(u'addressprogram_geoobject', 'construction')
