...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Construction.marker_icon'
        db.add_column(u'addressprogram_construction', 'marker_icon',
                      self.gf('django.db.models.fields.files.ImageField')(default='/media/images/logo.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Construction.marker_icon'
        db.delete_column(u'addressprogram_construction', 'marker_icon')
    ...
    models = {
        u'addressprogram.advertisingspace': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 1, 23, 0, 0)'}),
        ...
        u'addressprogram.construction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marker_icon': ('django.db.models.fields.files.ImageField', [], {'default': "'/media/images/logo.png'", 'max_length': '100'}),
