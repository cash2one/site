...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Construction.short_content'
        db.alter_column(u'addressprogram_construction', 'short_content', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Changing field 'Construction.short_content'
        db.alter_column(u'addressprogram_construction', 'short_content',
