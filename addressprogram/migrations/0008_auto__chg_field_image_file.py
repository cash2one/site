...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'addressprogram_image', 'file', self.gf('django.db.models.fields.files.ImageField')(default=' ', max_length=100))

    def backwards(self, orm):

        # Changing field 'Image.file'
        db.alter_column(u'addressprogram_image', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    models = {
        u'addressprogram.advertisingspace': {
            'Meta': {'ordering': "('address__address',)", 'object_name': 'AdvertisingSpace'},
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 29, 0, 0)'}),
