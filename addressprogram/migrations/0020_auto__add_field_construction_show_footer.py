...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Construction.show_footer'
        db.add_column(u'addressprogram_construction', 'show_footer',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Construction.show_footer'
        db.delete_column(u'addressprogram_construction', 'show_footer')
