...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'GeoObject.prod'
        db.add_column(u'addressprogram_geoobject', 'prod',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1,
                                                                            to=orm['addressprogram.Construction']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'GeoObject.prod'
        db.delete_column(u'addressprogram_geoobject', 'prod_id')
    ...
    models = {
        ...
        u'addressprogram.geoobject': {
            ...
            'prod': ('django.db.models.fields.related.ForeignKey', [],
                     {'default': '0', 'to': u"orm['addressprogram.Construction']"})
        },
