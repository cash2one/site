...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field available_constructions on 'City'
        m2m_table_name = db.shorten_name(u'addressprogram_city_available_constructions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('city', models.ForeignKey(orm[u'addressprogram.city'], null=False)),
            ('construction', models.ForeignKey(orm[u'addressprogram.construction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['city_id', 'construction_id'])


    def backwards(self, orm):
        # Removing M2M table for field available_constructions on 'City'
        db.delete_table(db.shorten_name(u'addressprogram_city_available_constructions'))
