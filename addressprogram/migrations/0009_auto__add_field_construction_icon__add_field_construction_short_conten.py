...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Construction.icon'
        db.add_column(u'addressprogram_construction', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(default='/media/images/logo.png',
                                                                          max_length=100),
                      keep_default=False)

        # Adding field 'Construction.short_content'
        db.add_column(u'addressprogram_construction', 'short_content',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Construction.order'
        db.add_column(u'addressprogram_construction', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Construction.show'
        db.add_column(u'addressprogram_construction', 'show',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Construction.content'
        db.add_column(u'addressprogram_construction', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Construction.slug'
        db.add_column(u'addressprogram_construction', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Construction.icon'
        db.delete_column(u'addressprogram_construction', 'icon')

        # Deleting field 'Construction.short_content'
        db.delete_column(u'addressprogram_construction', 'short_content')

        # Deleting field 'Construction.order'
        db.delete_column(u'addressprogram_construction', 'order')

        # Deleting field 'Construction.show'
        db.delete_column(u'addressprogram_construction', 'show')

        # Deleting field 'Construction.content'
        db.delete_column(u'addressprogram_construction', 'content')

        # Deleting field 'Construction.slug'
        db.delete_column(u'addressprogram_construction', 'slug')
