...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.distance'
        db.add_column(u'addressprogram_city', 'distance',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.distance'
        db.delete_column(u'addressprogram_city', 'distance')
    ...
    models = {
        u'addressprogram.advertisingspace': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 23, 0, 0)'}),
