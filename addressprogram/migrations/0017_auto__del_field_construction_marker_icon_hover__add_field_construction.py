...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Construction.marker_icon_hover'
        db.delete_column(u'addressprogram_construction', 'marker_icon_hover')

        # Adding field 'Construction.marker_icon_active'
        db.add_column(u'addressprogram_construction', 'marker_icon_active',
                      self.gf('django.db.models.fields.files.ImageField')(default='/media/images/type1-active.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Construction.marker_icon_hover'
        db.add_column(u'addressprogram_construction', 'marker_icon_hover',
                      self.gf('django.db.models.fields.files.ImageField')(default='/media/images/type1-active.png', max_length=100),
                      keep_default=False)

        # Deleting field 'Construction.marker_icon_active'
        db.delete_column(u'addressprogram_construction', 'marker_icon_active')
    ...
    models = {
        u'addressprogram.advertisingspace': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 1, 27, 0, 0)'}),
