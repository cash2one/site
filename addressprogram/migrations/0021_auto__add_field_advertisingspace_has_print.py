...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingSpace.has_print'
        db.add_column(u'addressprogram_advertisingspace', 'has_print',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvertisingSpace.has_print'
        db.delete_column(u'addressprogram_advertisingspace', 'has_print')
    ...
    models = {
        u'addressprogram.advertisingspace': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 2, 8, 0, 0)'}),
