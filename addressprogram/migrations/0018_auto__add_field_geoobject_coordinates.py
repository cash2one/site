...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeoObject.coordinates'
        db.add_column(u'addressprogram_geoobject', 'coordinates',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeoObject.coordinates'
        db.delete_column(u'addressprogram_geoobject', 'coordinates')
