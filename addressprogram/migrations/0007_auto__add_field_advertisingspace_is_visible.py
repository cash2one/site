...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingSpace.is_visible'
        db.add_column(u'addressprogram_advertisingspace', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvertisingSpace.is_visible'
        db.delete_column(u'addressprogram_advertisingspace', 'is_visible')
    ...
    models = {
        u'addressprogram.advertisingspace': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 27, 0, 0)'}),
