...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'CartItem.grp'
        db.alter_column(u'order_cartitem', 'grp', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CartItem.ots'
        db.alter_column(u'order_cartitem', 'ots', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Changing field 'CartItem.grp'
        db.alter_column(u'order_cartitem', 'grp',
                        self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'CartItem.ots'
        db.alter_column(u'order_cartitem', 'ots',
                        self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
