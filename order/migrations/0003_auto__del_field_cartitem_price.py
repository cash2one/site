...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.delete_column(u'order_cartitem', 'price')

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'CartItem.price'
        raise RuntimeError("Cannot reverse this migration. 'CartItem.price' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'CartItem.price'
        db.add_column(u'order_cartitem', 'price',
