    ...
    def __init__(self, verbose_name, plural_forms, **kwargs):
        ...
        if self._gender == 0:
            ...
            def msg(self, request, message):
                ...
                message = message.replace(u"Ниже вы можете снова его отредактировать",
                                          u"Ниже вы можете снова её отредактировать")
                ...
                if msg_addmore_re.match(message):
                    ...
                    message = message.replace(u"Ниже вы можете добавить еще один %s." % grp[1],
                                              u"Ниже вы можете добавить еще одну %s." % self.VerboseNameCaseReplace[
                                                  grp[1]])
